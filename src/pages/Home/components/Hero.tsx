...
import photo from '../../../assets/images/portfolio.webp'
...
const SocialIcons = () => {
    return (
        <div className="flex mt-4">
            ...
            <a href="https://www.linkedin.com/in/rafaelgaldinosilva81/" target="_blank" rel="noreferrer">
                <FaLinkedin className="text-5xl text-neutral-200 mx-2 hover:text-indigo-600 transition ease-in-out" />
            </a>
            <a href="https://www.instagram.com/rafaelsilva.81/" target="_blank" rel="noreferrer">
